<div class="container">
  ...
  <section class="content-header">
    <h1>
      ...
      <li><a href="?page=page_data_user_hold"><i class="fa fa-user"></i> Detail User Non-Aktif</a></li>
    </ol>
  </section>
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'Grafik Data User Non-Aktif'
    },
    subtitle: {
    ...
    // },
     {
        ...
        data: [
                <?php
                  foreach($select->select_grafik_user_hold('2018') as $data) {
                    $data_omset = $data;
                    echo $data_omset.",";
                  }
                ?>
