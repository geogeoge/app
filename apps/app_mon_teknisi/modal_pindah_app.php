		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<h4 class="modal-title" id="myModalLabel">
					<center>
						<input type="submit" class="btn btn-success" name ="pindah_teknisi" value="APLIKASI TEKNISI">
						&nbsp;
						<input type="submit" class="btn btn-success" name ="pindah_monitoring" value="APLIKASI MONITORING">
					</center>
				</h4>
				<br>
