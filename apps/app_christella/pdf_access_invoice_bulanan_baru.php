...
#destination 2
$detination_2 = $nama_instansi;
if($nama_instansi==""){
  $detination_2 = $pecah_alamat['3'].", ".$pecah_alamat['4'].", ".$pecah_alamat['5'];
}

#destination 3
$destination_3 = "Telp / HP : ".$telp;
...
$tampil_destination_2 = $detination_2;
...
$tampil_nominal_ip_publik = $nominal_ip_publik;
