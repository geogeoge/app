...
if(isset($_GET['update_status_ppn'])){
  ...
  $crud->update_status_ppn($update_status_ppn, $id_po);
}
...
if(isset($_POST['tombol_rubah_subisidi_marketing'])) {
  $update->rubah_subsidi_marketing($_POST['id_marketing'], $_POST['nominal_subsidi']);
}
...
if(isset($_POST['pindah_admin'])){
  $_SESSION['level']='ACCOUNTING_ADMIN';
  header('location:../../');
}

if(isset($_POST['pindah_accounting'])){
  $_SESSION['level']='ACCOUNTING';
  header('location:../../');
}

if(isset($_POST['pindah_pembantu'])){
  $_SESSION['level']='CHRISTELLA';
  header('location:../../');
}
