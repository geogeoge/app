                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td align="center"><a href="?data_yang_dicari=Pembayaran+User+Baru+&tanggal_awal=<?php echo $tanggal_awal;?>&tanggal_akhir=<?php echo $tanggal_akhir;?>&page=page_tampil_detail_tagihan_pak_eko" style="color: black;"><?php echo $select->select_data_temp_tagihan_pak_eko($tanggal_awal, $tanggal_akhir, 'Pembayaran User Baru '); ?></a></td>
                    </tr>
                    <tr>
