<section class="content-header">
  <h1 class="">
    ...
    <div class="tombol_tambah">
      <a href="?page=page_access_tambah_daftar_menu_cetak_invoice" class="btn btn-primary"><i class="fa fa-user-plus"></i>&nbsp;&nbsp;Tambah User</a>&nbsp;&nbsp;

      <a href="pdf_access_multi_invoice_bulanan.php" class="btn btn-primary" target="_blank" class="btn btn-primary"><i class="fa fa-print"></i>&nbsp;&nbsp;Cetak</a>
    </div>
  </h1>
</section>
      ...
      <div class="box">
        ...
        <div class="box-body scroll">
          <table  class="table table-bordered table-striped">
            ...
            <?php
            $no=1;
            foreach($crud->select_register_menu_cetak_invoice() as $data) {
            ...
            <tr>
              ...
              <td width="100" align="center">
                ...
                <a href="#hapus_cetak<?php echo $data['id_register']; ?>" role="button"  data-target = "#hapus_cetak<?php echo $data['id_register']; ?>" data-toggle="modal" class="btn btn-danger"><i class="fa fa-close"></i></a>
              </td>
            </tr>
          <?php
