        ...
        <form method="POST" class="form-horizontal">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Kabel</label>
              <div class="col-sm-3">
                <input type="text" name="tambahan_1" class="form-control" id="inputPassword3" value="<?php echo $tambahan_1;?>">
              </div>
              <label for="inputPassword3" class="col-sm-1 control-label">Panjang</label>
              <div class="col-sm-1">
                <input type="text" name="jumlah_tambahan_1" class="form-control" id="inputPassword3" value="<?php echo $jumlah_tambahan_1;?>">
              </div>
              <label for="inputPassword3" class="col-sm-1 control-label">Status</label>
              <div class="col-sm-2">
              ...
              <label for="inputPassword3" class="col-sm-1 control-label">Harga</label>
              <div class="col-sm-1">
                <input type="text" name="harga_tambahan_1" class="form-control" id="inputPassword3" value="<?php echo $harga_tambahan_1;?>">
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="inputPassword3" class="col-sm-2 control-label">Kabel</label>
              <div class="col-sm-3">
                <input type="text" name="tambahan_2" class="form-control" id="inputPassword3" value="<?php echo $tambahan_2;?>">
              </div>
              <label for="inputPassword3" class="col-sm-1 control-label">Panjang</label>
              <div class="col-sm-1">
                <input type="text" name="jumlah_tambahan_2" class="form-control" id="inputPassword3" value="<?php echo $jumlah_tambahan_2;?>">
              </div>
              <label for="inputPassword3" class="col-sm-1 control-label">Status</label>
              <div class="col-sm-2">
              ...
              <label for="inputPassword3" class="col-sm-1 control-label">Harga</label>
              <div class="col-sm-1">
                <input type="text" name="harga_tambahan_2" class="form-control" id="inputPassword3" value="<?php echo $harga_tambahan_2;?>">
              </div>
            </div>
          ...
          <div class="box-footer">
            ...
            <button name="update_register" type="submit" class="btn btn-primary pull-right">Update</button>
          </div>
          <!-- /.box-footer -->
        </form>
      </div>
