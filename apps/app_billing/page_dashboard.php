<section class="content-header">
  <h1>
    ...
    <div class="tombol_tambah">
      <a href="?page=page_access_menu_tagihan_khusus" class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;&nbsp;<span>Buat Tagihan Khusus</span></a>
...
<?php include "modal_access_alert_tagihan_khusus.php";?>
