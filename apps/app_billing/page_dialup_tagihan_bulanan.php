      ...
      <div class="box">
        ...
        <div class="box-body scroll">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
            $no=1;
            foreach($crud->select_tagihan_dialup() as $data) {
              ...
              $simbol_biaya_penagihan="<i class='fa fa-close'></i>";
              $update_status_biaya="2500";
              $biaya_tagihan = $data['billing_biaya_penagihan'];
              if($biaya_tagihan>0){
                $simbol_biaya_penagihan="<i class='fa fa-check'></i>";
                $update_status_biaya="0";
              }


              $billing_saldo = $data['billing_saldo'];
              $tunggakan = $billing_saldo;
              $saldo = 0;
              if($billing_saldo<0){
                $tunggakan = 0;
                $pecah_billing_saldo = explode("-", $billing_saldo);
                $saldo = $pecah_billing_saldo['1'];
              }
            ?>
            <tr>
              ...
              <td align="left"><?php echo $data['user_id']; ?></td>
