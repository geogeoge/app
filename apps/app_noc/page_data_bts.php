...
$sql="SELECT  * FROM mon_databts LEFT JOIN mon_lokasibts ON mon_databts.lokasi=mon_lokasibts.id_lokasi_bts WHERE mon_databts.$via like '%$isi_data%' LIMIT $limit_awal, $limit_akhir";
