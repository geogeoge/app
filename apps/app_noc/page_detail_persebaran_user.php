                ...
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="50" align="center"><a href="#modal_edit_kapasitas<?php echo $data['id_bts']; ?>" role="button"  data-target = "#modal_edit_kapasitas<?php echo $data['id_bts']; ?>" data-toggle="modal" style="color: black;"><b><?php echo $kapasitas_bts; ?></b></a></td>
                      <td width="50" align="center"><b><?php echo $jumlah_sale_register; ?></b></td>
                    </tr>
                    <?php
                    include "modal_edit_kapasitas.php";
                    }
