            ...
            <div class="row">
              ...
              <form method="POST">
                <table class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                     foreach ($select->select_data_temp_where('1', 'o', $tanggal_awal, $tanggal_akhir, $limit, 'belum') as $data) {
                    ?>
                    <tr>
                    ...
                    if(!($select->select_data_temp_where('1', 'o', $tanggal_awal, $tanggal_akhir, $limit, 'belum'))) {
                      ?>
                      <tr class="odd">
