...
<section class="content-header">
  <h1 class="">
    ...
    &nbsp;
    <a href="pdf_laba_rugi_access.php?tanggal_awal=<?php echo $tanggal_awal;?>&tanggal_akhir=<?php echo $tanggal_akhir;?>" target="_blank" class="btn btn-primary">Download</a>
  </h1>
</section>
