...
if(isset($_POST['tombol_buat_jadwal_pemasangan'])) {
  $update->proses_penjadwalan($_POST['id_register'], $_POST['tanggal_penjadwalan'], $_POST['teknisi'], $_POST['partner']);
}
...
if(isset($_POST['tombol_konfirmasi_permintaan_batal'])) {
    $delete->delete_permintaan_maintenance();
}
...
<head>
  ...
  <title>PENJADWALAN | SOLONET</title>
