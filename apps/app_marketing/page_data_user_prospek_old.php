...
<section class="content">
  <div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs pull-right">
      <li class="active"><a href="?page=page_data_user_prospek_old">OLD PROSPEK</a></li>
      <li><a href="?page=page_data_user_prospek">PROSPEK</a></li>
      <li class="pull-left header">Data User OLD</li>
    </ul>
      ...
      <div class="tab-pane active" style="position: relative; ">
        <div class="box-body scroll">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <?php
            $no="1";
            foreach($select->select_data_user_prospek_old($login_id_marketing) as $data) {
