...
if(isset($_POST['proses_transaksi'])) {
  $crud->insert_pemabayaran();
}

if(isset($_POST['simpan_user_prospek'])) {
  $crud->insert_user_prospek($login_id_marketing);
}

if(isset($_POST['proses_registrasi'])) {
  $crud->insert_user_trial($login_id_marketing);
}

if(isset($_POST['update_register'])) {
  $crud->update_user_trial();
}

if(isset($_POST['tombol_perpanjang'])) {
  $crud->update_perpanjang_trial();
}

if(isset($_POST['tombol_clossing'])) {
  $crud->update_closing_trial();
}

if(isset($_POST['tombol_cancel'])) {
  $crud->update_cancel_trial();
}

if(isset($_POST['update_user_close'])) {
  $crud->update_user_close();
}
...
if(isset($_POST['hapus_data_user_prospek'])) {
  $delete->hapus_user_prospek();
}

if(isset($_POST['update_user_prospek'])) {
  $update->update_user_prospek($login_id_marketing);
}
