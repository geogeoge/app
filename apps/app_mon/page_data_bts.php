              ...
              <div class="col-sm-7">
                <div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
                  <ul class="pagination">
                    ...
                    <?php
                    $query_pagination = mysqli_query($koneksi,"SELECT  * FROM mon_databts LEFT JOIN mon_lokasibts ON mon_databts.lokasi=mon_lokasibts.id_lokasi_bts WHERE mon_databts.$via like '%$isi_data%' ORDER BY lokasi");
