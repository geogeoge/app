...
<section class="content">
  <div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs pull-right">
      <li <?php if(empty($_GET['id_marketing'])){ echo "Class='active'";} ?>><a href="?page=page_data_user_hold">SEMUA</a></li>
      <?php
      ...
      ?>
      <li <?php echo $active;?>><a href="?page=page_data_user_hold&id_marketing=<?php echo $id_data_marketing;?>"><?php echo $nama['0']; ?></a></li>
      <?php
      }
      ?>
      <li class="pull-left header"><i class="fa fa-inbox"></i> User Hold</li>
    </ul>
      ...
      <div class="tab-pane active" style="position: relative; ">
        <div class="box-body scroll">
          <table id="example1" class="table table-bordered table-striped">
            ...
            foreach($data_user_close->select_data_user_hold_per_marketing($id_marketing) as $data) {
            ?>
            <tr>
