<div class="modal fade" id="tambah_label" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<form method="POST">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<div class="alert alert-info"><strong><center>TAMBAH DATA LABEL </center></strong></div>
			</div>
			        ...
			        <div class="col-md-6">
			          ...
			          <div class="form-group">
			            ...
			            <select name="nama_gedung_a" class="form-control select2" style="width: 100%;">
			              ...
			              ?>
			              <option><?php echo $data['nama_gedung']; ?></option>
			              <?php
			              }
			              ?>
			            </select>
			...
			<div class = "modal-footer">
				<button name = "simpan_data_label" class="btn btn-primary">Simpan</button>
